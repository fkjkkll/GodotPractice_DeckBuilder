...
const SHOP_CARD = preload("uid://bgcsejrs7qque")
const SHOP_RELIC = preload("uid://cmvacfd8nk6ui")
...
func _blink_timer_setup() -> void:
	blink_timer.wait_time = randf_range(1.0, 3.0)
	blink_timer.start()
...
func _generate_shop_cards() -> void:
	...
	var available_cards: Array[Card] = char_stats.draftable_cards.cards.duplicate_deep(Resource.DEEP_DUPLICATE_ALL)
